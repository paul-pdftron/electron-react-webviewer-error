# electron-react-webviewer-error
A clone of the electron-react-boilerplate project with PDFTron added to reproduce error

# Attention PDFTron Team

I cloned the below boilerplate project and added `@pdftron/webviewer@6.3.1` to the project. 

In order to reproduce the errors: 

1. Clone Repo
2. npm install
3. npm run dev

Console will initially show the Instance successfully

4. Refresh the application using Command + R or Cntrl + R 
...
## Failure on any refreshes
<img src="internals/img/failure.png" width="100%">


## Electron React Boilerplate Project
